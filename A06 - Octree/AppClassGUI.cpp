...
#pragma region Debugging Information
	...
	//m_pMeshMngr->Print("						");
	m_pMeshMngr->PrintLine("Final Deliverable", C_YELLOW);
	//m_pMeshMngr->Print("						");
...
#pragma endregion
	...
	if (m_bGUI_Main)
	{
		...
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::Text("   Destroy all the bricks by\n");
			ImGui::Text("   bouncing the ball off the platform\n");
			ImGui::Separator();
			ImGui::Text("Controls:\n");
			...
			ImGui::Separator();
			ImGui::TextColored(ImColor(255, 255, 0), "Final\n");
		}
		ImGui::End();
	}
